...
- [x] 9. Deploy — Pages Source switched to "GitHub Actions", `.nojekyll` added (the live site was initially serving the old branch-based Jekyll deployment, which returned the raw unbuilt `/src/main.tsx` and broke module loading — a fresh push resolved it), live and verified at https://stefan-janicijevic.github.io
